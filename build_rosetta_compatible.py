#!/usr/bin/env python3
"""
Скрипт для создания приложения, совместимого с Intel Mac через Rosetta 2
"""
...
def create_rosetta_wrapper():
    """Создаем wrapper для Rosetta 2"""
    print("🔧 Создаем Rosetta 2 wrapper...")
...
# Rosetta 2 Wrapper для SurveyApp
...
"""
    ...
    # Создаем wrapper
    wrapper_path = f"{app_path}/Contents/MacOS/SurveyApp_Wrapper"
    ...
    if os.path.exists(original_path):
        ...
        shutil.move(wrapper_path, original_path)
        print("✅ Rosetta 2 wrapper создан!")
        return True
    else:
...
```bash
# Запустите через Rosetta 2
arch -x86_64 /Applications/SurveyApp.app/Contents/MacOS/SurveyApp
```
...
4. Запустите через Rosetta: `arch -x86_64 /Applications/SurveyApp.app/Contents/MacOS/SurveyApp`
"""
...
def main():
    """Главная функция"""
    print("🍎 Создание SurveyApp для Mac (Intel + Apple Silicon)")
    print("=" * 60)
